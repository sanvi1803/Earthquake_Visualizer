      ...
      {data.features.slice(0, 12).map((feature: any) => (
        ...
        >
          <div>
            ...
            <div className="mb-1">
              <span className="font-semibold text-rose-700 dark:text-rose-400">Magnitude:</span> {feature.properties.mag}
            </div>
            <div className="mb-1">
              <span className="font-semibold text-sky-700 dark:text-sky-300">Location:</span> {feature.properties.place}
            </div>
            <div className="mb-2">
              <span className="font-semibold text-emerald-700 dark:text-emerald-300">Time:</span> {new Date(feature.properties.time).toLocaleString()}
            </div>
          </div>
          <a
