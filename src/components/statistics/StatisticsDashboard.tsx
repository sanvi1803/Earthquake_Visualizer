...
export const StatisticsDashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-4 py-3 fade-in-up">
      ...
      <div className="text-center mb-8">
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Compare magnitudes, study frequency over time, and uncover geographic
          hotspots to gain a clearer understanding of global earthquake
          patterns.
        </p>
      </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="w-24 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          (magnitudeRanges.strong / totalCount) * 100
                        }%`,
                      }}
                    ></div>
                  </div>
