...
//   const navItems = [
//     { id: "visualizer", label: "Earthquake Visualizer", icon: Globe },
//     { id: "statistics", label: "Statistics Dashboard", icon: Globe },
//   ];

//   return (
//     <header className="bg-gradient-to-r from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm">
...
export default function Header({ onNavigate, currentPage }: HeaderProps) {
  ...
  const navItems = [
    ...
    { id: "charts", label: "Chart Visualization", icon: PieChart },
